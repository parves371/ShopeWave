...
const Checkout = () => {
  ...
  return (
    <section>
      <Container>
        <Breadcrumb
          className={"mt-12 sm:mt-16 lg:mt-20 xl:mt-24 ml-5 sm:ml-8 lg:ml-10 xl:ml-12 cd:mt-[124px] cd:ml-0"}
        ...
        <form>
          <h2 className="mt-3 ml-5 sm:ml-8 lg:ml-10 xl:ml-12 cd:ml-0">Billing Details</h2>
          <Flex className={"gap-9 mt-10 justify-between cd:w-[1055px] px-5 sm:px-8 lg:px-10 xl:px-12 cd:px-0"}>
            <Inpute
              className={"w-[500px]"}
              type={"text"}
              label={"First Name *"}
          ...
          <Inpute
            className={"cd:w-[1055px] mt-6 px-5 sm:px-8 lg:px-10 xl:px-12 cd:px-0"}
            type={"text"}
          ...
          <div className="cd:w-[1040px] mt-6 sm:mt-8 lg:mt-10 px-5 sm:px-8 lg:px-10 xl:px-12 cd:px-0">
            <label htmlFor="">Other Notes (optional)</label>
            <textarea
              name=""
              id=""
              cols="30"
        ...
        <Flex
          className={"cd:w-[644px] mt-10 border border-[#F0F0F0] flex-wrap mx-5 sm:mx-8 lg:mx-10 xl:mx-12 cd:mx-0"}
        >
        ...
        <div className="cd:w-[1053px] border border-[#F0F0F0] mt-14 mx-5 sm:mx-8 lg:mx-10 xl:mx-12 cd:mx-0">
          <div className={"mx-5 sm:mx-8 lg:mx-10 xl:mx-12 py-6 flex-col gap-y-4 "}>
          <input type="radio" name="bank" id="bank"/>
            ...
            <button className="px-6 py-4 bg-[#262626] text-white mt-6 mr-4 cd:mr-0">Proceed to Bank</button>
          </div>
        </div>
      </Container>
    </section>
